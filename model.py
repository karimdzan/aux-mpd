    ...
    def disc_loss(self, batch, features):
        ...
        if self.generator.training and self.discriminator.training:
            gradient_penalty = self.calculate_penalty(self.discriminator,
                                                      ...
                                                      features,
                                                      self.device)
            errD = (-errD_real + errD_fake + gradient_penalty * self.gp_lambda) + self.LOSS_WEIGHT * reg_loss
        else:
            errD = (-errD_real + errD_fake) + self.LOSS_WEIGHT * reg_loss
